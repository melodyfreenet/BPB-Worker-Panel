...
const generateRemark = (index, port) => {
    ...
    switch (index) {
        case 0:
        case 1:
            remark = `Melodyfreenet - Domain_${index + 1} : ${port}`;
            break;
        case 2:
        case 3:
            remark = `Melodyfreenet - IPv4_${index - 1} : ${port}`;
            break;
        case 4:
        case 5:
            remark = `Melodyfreenet - IPv6_${index - 3} : ${port}`;
            break;
        default:
            remark = `Melodyfreenet - Clean IP_${index - 5} : ${port}`;
            break;
    }
...
const buildWorkerLessConfig = async (env, client) => {
    ...
    fragConfig.remarks  = 'Melodyfreenet Frag - WorkerLess ⭐'
...
const getFragmentConfigs = async (env, hostName, client) => {
    ...
    bestPing.remarks = 'Melodyfreenet Frag - Best Ping 💥';
    ...
    bestFragment.remarks = 'Melodyfreenet Frag - Best Fragment 😎';
...
const getWarpConfigs = async (env, client) => {
    ...
    xrayWarpBestPing.remarks = 'Melodyfreenet - Warp Best Ping 🚀'
    ...
    xrayWarpOutbounds.forEach((outbound, index) => {
        xrayWarpConfigs.push({
            ...xrayWarpConfig,
            remarks: `Melodyfreenet - Warp ${index + 1} 🇮🇷`,
    ...
    xrayWoWOutbounds.forEach((outbound, index) => {
        if (outbound.tag.includes('warp-out')) {
            ...
            xrayWoWConfig.remarks = `Melodyfreenet - WoW ${index/2 + 1} 🌍`;
